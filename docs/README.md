...
- [`nomina_correo_ses.md`](nomina_correo_ses.md) — `POST /rrhh/payroll/notify` (`channels: ["email"]`): correo al empleado por AWS SES con el pdf/xml del recibo adjuntos desde S3 (`Functions_Mail.py` genérico); `channels_failed`/`email_to` nuevos; `POST /payroll/mail` retirado. · 2026-09-17 · ⏳ levantar SES en AWS; front
