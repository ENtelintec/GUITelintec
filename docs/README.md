...
Ver también: [`control_table_operaciones_y_campos_admin.md`](control_table_operaciones_y_campos_admin.md) (permiso `operaciones` en el mismo GET) · [`remission_history_changes.md`](remission_history_changes.md) · [`remission_items_json_remove_fix.md`](remission_items_json_remove_fix.md) · [`gestion_de_compras.md`](gestion_de_compras.md) (precedente de validación floja)
...
- [`migracion_esquemas_rrhh.md`](migracion_esquemas_rrhh.md) — plan por fases para mover las tablas de RRHH a `sql_telintec_mod_rrhh` con vistas puente: Fase 1 (`tasks_gui`→`quizz_tasks`) y Fase 2 (5 privadas + `aptitude`) ejecutadas; sin cambio de API. · 2026-08-07 · ⏳ regresión, deploy de prod y DROP de las 7 vistas
...
Ver también: serie de envelopes `{data, msg, error}` → [`contract_crud_response_envelope.md`](contract_crud_response_envelope.md) (receta + tabla viva), [`sm_response_envelope.md`](sm_response_envelope.md), [`almacen_response_envelope.md`](almacen_response_envelope.md) · PDFs con el estilo de la casa → [`sm_pdf_grid_redesign.md`](sm_pdf_grid_redesign.md), [`remission_pdf_download.md`](remission_pdf_download.md), [`checklist_vehicular_pdf.md`](checklist_vehicular_pdf.md), [`quizz_models_crud.md`](quizz_models_crud.md)
