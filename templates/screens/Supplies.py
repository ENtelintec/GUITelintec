...
class SuppliesScreen(ttk.Frame):
    ...
    def create_content(self, parent):
        ...
        ttk.Label(
            table, text="Tabla de Suministros", style="bg.TLabel", font=("Arial", 20)
        ).grid(row=0, column=0, sticky="w", padx=5, pady=10)
    ...
    def fetch_supply_stock(self):
        return self._data._internal_stock.fetch_supply_stock()
    ...
    def update_product(self):
        ...
        self._data._internal_stock.update_product_supply(
            product_id,
            product_sku,
            product_name,
            product_stock,
    ...
    def add_product(self):
        ...
        if product_id == "":
            self._data._internal_stock.create_product_supply(
                product_sku,
                product_name,
                product_stock,
            )
    ...
    def delete_product(self):
        ...
        if product_id == "":
            return
        self._data._internal_stock.delete_product_supply(product_id)
        time.sleep(0.5)
        self.clear_fields()
        time.sleep(0.5)
        self.update_table()
