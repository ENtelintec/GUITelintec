...
def QuizzNor035_v1(
    ...
    note_txt = (
        "*NOTA: Si en esta SECCIÓN  I.- Acontecimiento traumático severo  tu respuesta es NO, "
...
def QuizzNor035_50Plus(
    ...
    file_name = (
        "files/quizz_out/norm035_50_plus.pdf" if filepath_out is None else filepath_out
    )
    image_logo = "img/logo_docs.png" if image_logo is None else image_logo
