...
from templates.Function_midleware_almacen import get_all_movements, insert_movement, update_movement, \
    get_all_products_DB, insert_product_db, update_product_amc
...
class MovementDB(Resource):
    ...
    def post(self):
        ...
        return {"data": result, "msg": "Ok" if flag else "Error"}, 201 if flag else 400
    ...
    def put(self):
        ...
        return {"data": result, "msg": "Ok" if flag else "Error"}, 200 if flag else 400
