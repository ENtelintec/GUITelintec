...
from templates.controllers.employees.employees_controller import get_sm_employees, get_employees_op_names, get_employees
...
from templates.controllers.product.p_and_s_controller import get_ins_db, get_all_suppliers, get_all_products_db, \
    get_outs_db
...
class DataLoader(threading.Thread):
    ...
    def load_data(self):
        ...
        for item in self.windows:
            data_dic = load_data(data_dic, self.is_super, self.emp_id, item, self.permissions)
            self._ndata += 1
